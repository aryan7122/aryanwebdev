...
const Data = () => {
    return (
        <div className='grid grid-cols-1 gap-4 p-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3'>
            ...
            <Projects title="Portfolio Website" language="HTML, CSS, JavaScript, React" image={aryanweb} linkgithub='https://github.com/aryan7122/portfolio/blob/master/src/img/p1.png' live='' />
