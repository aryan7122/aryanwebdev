...
import Tic_tac  from  '../../img/project/game2.png';
...
const Data = () => {
    return (
        <div className='grid grid-cols-1 gap-4 p-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3'>
            ...
            <Projects title="ToDo App" language="HTML, CSS, JavaScript, React.js, Firebase, NextJs" image={todof} linkgithub='https://github.com/aryan7122/Todo_APP_firebase' live='' />
            <Projects title="E-Commerce HeadPhone" language="HTML, CSS, JavaScript, React.js" image={ecomercheadphon} linkgithub='https://github.com/aryan7122/puzzle_game_number_guess' live='https://vocal-bublanina-4054e9.netlify.app/' />
            <Projects title="puzzle game" language="HTML, CSS, JavaScript, React.js" image={puzzlegame} linkgithub='https://github.com/aryan7122/puzzle_game_number_guess' live='https://guess-puzzle.netlify.app/' />
            <Projects title="Portfolio Website" language="HTML, CSS, JavaScript, React.js" image={aryanweb} linkgithub='https://github.com/aryan7122/portfolio' live='' />
            ...
            <Projects title="Tic-Tac-Toe" language="HTML, CSS, JavaScript React.js" image={Tic_tac} linkgithub='https://github.com/aryan7122/Tic-Tac-Toe' live='https://x-o-play.netlify.app/' />
